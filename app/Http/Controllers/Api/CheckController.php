...
class CheckController extends Controller
{
    ...
    public function riwayat()
    {
        ...
        $data = Check::where('gudang_id', auth('sanctum')->user()->gudang_id)->get();
        return response()->json([
            'status' => 'ok',
            'data' => $data,
        ]);
    }
    public function driwayat()
    {

        $data = Check::where('gudang_id', auth('sanctum')->user()->gudang_id)->with(['user.gudang', 'barcode.masuk' => function ($xx) {
