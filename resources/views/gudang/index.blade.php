          ...
          <div class="card-body">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <form class="theme-form" action="{{route('gudang.create')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
            ...
            <div class="table-responsive invoice-table" id="table">
              <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <div class="modal fade" id="editModal{{$b->id}}" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                                <form class="theme-form" action="{{route('gudang.edit',$b->id)}}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                    @method('put')
                                  <div class="form-group">
                                      <input class="form-control" type="text" placeholder="Nama Barang" name="name" value="{{$b->name}}">
                                    </div>
                                    <div class="modal-footer ">
                                      <button class="btn btn-primary">Add</button>
                ...
                {{-- Modal Delete --}}
                <div class="modal fade" id="deleteModal{{$b->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">
                              <form class="theme-form" action="{{route('gudang.delete',$b->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('delete')
