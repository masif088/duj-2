      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="theme-form" action="{{route('serviceAfter.edit',$id->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="form-group mb-3">
                  <label class="col-form-label">Nama Barang</label>
                  <input class="form-control" type="text" value="{{$id->after->barcode->masuk->barang->name}}" placeholder="ABC" name="name" disabled>
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea rows="5"  id="Sparepart" type="text"
                                class="form-control @error('sparepart') is-invalid @enderror" placeholder="sparepart" name="sparepart"
                                 required autocomplete="sparepart"  autofocus>{{$id->sparepart}}</textarea>
                  @error('sparepart')
                    <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                    </span>
