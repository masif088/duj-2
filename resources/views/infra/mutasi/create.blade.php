      ...
      <table class="table table-bordered table-striped tabel-form-barang">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div class="main">
                  <input type="text"  name="Nama_Barang[]"  class="form-control" placeholder="Nama Barang" value="{{$gudd->infra->name}}" disabled/>
                </div>
              </td>
              <td>
                <input type="text"  name="g_awal[]"  class="form-control" placeholder="Gudang Awal" value="{{$gudd->infra->gudang->name}}" disabled/>
              </td>
              <td>
                    <input type="text" name="g_tujuan[]" class="form-control" placeholder="Gudang Tujuan" value="{{$gudd->gudang->name}}" disabled/>
                  </td>
                  <td>
                    <a href="{{route('infraM.delete',$gudd->id)}}">
