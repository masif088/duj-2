                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body m-l-20">
                                            ...
                                            <p>{{$mutasi[0]->user->name}}<br><span
                                                    class="digits">{{$mutasi[0]->infra->gudang->name}}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="m-0">{{$m->infra->name}}</p>
                                                </td>
                                                <td>
                                                    <p class="itemtext digits">{{$m->infra->gudang->name}}</p>
                                                </td>
                                                <td>
                                                    <p class="itemtext digits">{{$m->gudang->name}}</p>
                                                </td>
                                                <td>
                                                    <p class="itemtext digits">{{$m->infra->kode}}</p>
                                                </td>
                                                <td>
                                                    {{-- @php
