                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <form class="theme-form" action="{{route('barang.create')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                  ...
                  <tbody>
                    ...
                    <div class="modal fade" id="editModal{{$b->id}}" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                                <form class="theme-form" action="{{route('barang.edit',$b->id)}}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                    @method('put')
                                  <div class="form-group">
