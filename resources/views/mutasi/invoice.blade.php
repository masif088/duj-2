                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="text-md-right">
                        <h3>Invoice #<span class="digits counter">{{$mutasi[0]->kode_mutasi}}</span></h3>
                        <p>Checkout berhasil: {{$mutasi[0]->created_at->format('M')}}<span class="digits"> {{$mutasi[0]->created_at->format('d,Y')}} |</span><span class="digits"> {{$mutasi[0]->created_at->format('H:s')}} WIB</span></p>
                      </div>
                      <!-- End Title-->
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="media">
                      ...
                      <div class="media-body m-l-20">
                        ...
                        <p>{{$mutasi[0]->user->name}}<br><span class="digits">{{$mutasi[0]->barcode->masuk->gudang->name}}</span></p>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-8">
